...
<body link="" vlink="" alink="">
    ...
    <div class="pane flipwrapper">
        <header>
          ...
          <h3>UNIVERSITY OF CEBU-PRI<br>STUDENT REGISTRATION FORM</h3>
        ...
        <form method="POST" action="studentform.php" >
            ...
            <input type="text" placeholder="Middle Inital" name="middle" maxlength="2" >
          	...
          	<div class="field">
				...
				<option selected hidden>Year Level*</option>
				<option value="Grade 11">Grade 11</option>
				<option value="Grade 12">Grade 12</option>s
				</select>
			</div>
			<div class="field">
          		<select name="trackstrand" required>
				<option selected hidden>Track/Strand*</option>
